  ...
  return (
    <section className="mx-auto w-full max-w-xl rounded-xl border border-black/8 bg-white p-8 transition-colors duration-300 dark:border-white/8 dark:bg-[#151515] sm:p-10">
      <div className="mb-10 text-center">
        ...
        <div className="mx-auto mb-4 mt-4 flex h-16 w-16 items-center justify-center rounded-lg border border-black/8 bg-[#f8f6f3] text-[#8a6a43] dark:border-white/8 dark:bg-white/6 dark:text-[#d7b37a]">
      ...
      {state.status !== 'idle' ? (
        <div
          className={`mb-8 flex items-center gap-3 rounded-lg border px-5 py-4 text-sm font-bold transition-colors ${state.status === 'success'
      ...
      <form action={formAction} className="space-y-6">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div className="sm:col-span-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                value={email}
                readOnly
                className="h-12 w-full cursor-not-allowed rounded-lg border border-black/8 bg-[#f8f6f3] pl-11 pr-4 text-xs font-bold text-slate-500 outline-none dark:border-white/8 dark:bg-white/6 dark:text-slate-500"
              />
            </div>
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative group">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#8a6a43] dark:group-focus-within:text-[#d7b37a]">
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </span>
              <input
                ...
                className="h-12 w-full rounded-lg border border-black/8 bg-[#f8f6f3] pl-11 pr-4 text-sm font-bold text-slate-900 outline-none transition-colors placeholder-slate-400 focus:border-[#8a6a43]/35 focus:bg-white dark:border-white/8 dark:bg-white/6 dark:text-white dark:placeholder-slate-600 dark:focus:border-[#d7b37a]/50 dark:focus:bg-white/8"
              />
            </div>
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={isPending}
          className="flex h-12 w-full cursor-pointer items-center justify-center gap-3 rounded-lg border border-[#8a6a43] bg-[#8a6a43] text-sm font-black uppercase tracking-widest text-white transition-colors hover:border-[#765936] hover:bg-[#765936] active:scale-95 disabled:cursor-not-allowed disabled:opacity-70 dark:border-[#d7b37a] dark:bg-[#d7b37a] dark:text-[#151515] dark:hover:border-[#c9a15e] dark:hover:bg-[#c9a15e] sm:h-14"
        >
          {isPending ? (
